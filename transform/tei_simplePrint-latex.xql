(:~
    ...
    ODD: /db/apps/SNNJ/resources/odd/tei_simplePrint.odd
 :)
xquery version "3.1";
    ...
    $input !         (
            ...
            return
                            ...
                            if (parent::table) then
                                ...
                                if (parent::lg) then
                                    ...
                                    if (parent::list) then
                                        ...
                                        if (parent::div) then
                                            latex:heading($config, ., ("tei-head5"), ., count(ancestor::div))
                                        else
                    ...
                    case element(teiHeader) return
                        latex:metadata($config, ., ("tei-teiHeader"), .)
